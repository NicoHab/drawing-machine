"""
BlockchainDataValidator implementation.
...
class BlockchainDataValidatorError(Exception):
    """Custom exception for BlockchainDataValidator errors."""

    pass


class BlockchainDataValidator(BaseModel):
    """
    BlockchainDataValidator implementation following Drawing Machine patterns.
