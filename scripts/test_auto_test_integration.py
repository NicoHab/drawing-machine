...
def test_filewatcher_with_tests():
    ...
    print(f"Auto-test execution: {'ENABLED' if watcher.enable_auto_tests else 'DISABLED'}")
...
def demo_complete_workflow():
    ...
    print("python scripts/auto_test_runner.py --run-test tests/unit/test_foundational_models.py")
    print()
