...
def test_tdd_workflow_basic():
    ...
    assert "test_json_serialization" in test_content, "Should include JSON serialization tests"
    ...
    assert "model_validate_json_safe" in impl_content, "Should include safe JSON validation"
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\nUsage examples:")
        print("1. Import: from scripts.tdd_workflow import TestFirstWorkflow, create_component_specification")
        print("2. Create spec: spec = create_component_specification(name='MyComponent', ...)")
