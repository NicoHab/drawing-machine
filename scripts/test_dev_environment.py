...
class DevEnvironmentTester:
    ...
    def test_docker_containers(self) -> bool:
        ...
        try:
            ...
            if missing:
                self.log_test("Docker Containers", False, f"Missing containers: {missing}")
                return False
            else:
                self.log_test("Docker Containers", True, "All expected containers running")
                return True
    ...
    def test_postgres_connectivity(self) -> bool:
        ...
        try:
            ...
            self.log_test("PostgreSQL Dev DB", True, f"Connected successfully - {version[:50]}...")
            return True
    ...
    def test_tcp_motor_controller(self) -> bool:
        ...
        try:
            ...
            if "ACK" in response:
                ...
                self.log_test("TCP Motor Controller", False, f"Unexpected response: {response}")
                return False
    ...
    def test_monitoring_services(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("Prometheus", False, f"Health check failed: {response.status_code}")
                success = False
        except Exception as e:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("Grafana", False, f"Health check failed: {response.status_code}")
                success = False
        except Exception as e:
    ...
    def test_network_connectivity(self) -> bool:
        ...
        try:
            ...
            if "drawing-machine_default" in result.stdout:
                self.log_test("Docker Network", True, "drawing-machine_default network exists")
                return True
            else:
                self.log_test("Docker Network", False, "drawing-machine_default network not found")
                return False
