...
class TestEthereumDataSnapshot:
    ...
    def test_ethereum_data_creation(self):
        ...
        data = EthereumDataSnapshot(
            ...
            api_response_times=ApiResponseTimes(
                coinbase_ms=100.0, ethereum_rpc_ms=150.0, beacon_chain_ms=120.0
            ),
        )
    ...
    def test_data_quality_models(self):
        ...
        api_times = ApiResponseTimes(
            coinbase_ms=100.0, ethereum_rpc_ms=200.0, beacon_chain_ms=150.0
        )
...
class TestSharedModelFeatures:
    ...
    def test_model_edge_cases(self):
        ...
        api_times = ApiResponseTimes(
            coinbase_ms=0.0, ethereum_rpc_ms=0.0, beacon_chain_ms=0.0  # Minimum value
        )
...
def test_shared_directory_structure():
    ...
    expected_files = ["blockchain_data.py", "motor_commands.py", "drawing_session.py"]
